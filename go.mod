...
require (
	...
	github.com/sentioxyz/arbiter-proto v0.2.0
...
require (
	...
	github.com/tobilg/polyglot/packages/go v0.6.1 // indirect
...
require (
	...
	github.com/housegate/rewriter-go v0.4.1
	github.com/housegate/rewriter-proto v0.1.0
