...
type Hooks interface {
	...
	OnClientData(ctx context.Context, qctx *QueryContext, raw []byte) ([]byte, error)
...
func (NoopHooks) OnClientData(_ context.Context, _ *QueryContext, raw []byte) ([]byte, error) {
	return raw, nil
}
