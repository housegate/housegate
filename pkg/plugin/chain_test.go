...
func (p *prepareQueryPlugin) OnQuery(_ context.Context, qctx *QueryContext) error {
	*p.called = append(*p.called, p.name)
	...
	}, PersistForwardIntent: func(context.Context, PreparedAgentQuery) error { return nil }, AuthorizeForward: func(context.Context, PreparedAgentQuery) error { return nil }, PersistForwardUnknown: func(context.Context, PreparedAgentQuery) error { return nil }, MaxControlBytes: 1024}
	return nil
}
