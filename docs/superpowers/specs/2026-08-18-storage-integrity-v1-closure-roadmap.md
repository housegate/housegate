...
> **Update 2026-08-19:** Specs A, C and G are implemented and merged; F exists on a production branch. The 2026-08-19 implementation review found two Critical fail-closed gaps in G, one High commitment-durability gap in A, four High findings in C, four blockers in F, and a systemic verification-coverage shortfall. Remediation is indexed by [2026-08-19 remediation roadmap](2026-08-19-storage-integrity-remediation-roadmap.md) (Specs I–M), which must land before the devnet2 pilot.
